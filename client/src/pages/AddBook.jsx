...
export default class Book extends Component {
    constructor(props) {
        ...
        this.Schema = Yup.object().shape({
            title: Yup.string().required('This field is required').min(3, 'Too Short!').max(100, 'Too Big!'),
            author: Yup.string().required('This field is required').min(3, 'Too Short!').max(100, 'Too Big!'),
            publisher: Yup.string().required('This field is required').min(3, 'Too Short!').max(100, 'Too Big!'),
            category: Yup.string().required('This field is required').min(3, 'Too Short!').max(100, 'Too Big!'),
        });
    }
